        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12 md:gap-8">
          ...
          <nav aria-label="Footer" className="grid grid-cols-2 sm:grid-cols-3 gap-8 md:gap-14">
            <div className="flex flex-col gap-3">
              ...
              <a href="#lab" className="text-white/85 hover:text-sunset font-light text-sm transition-colors">
                What happens
              </a>
              <a href="#science" className="text-white/85 hover:text-sunset font-light text-sm transition-colors">
                The science
              </a>
              <a href="#book" className="text-white/85 hover:text-sunset font-light text-sm transition-colors">
                Book a session
              </a>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <a href="#faq" className="text-white/85 hover:text-sunset font-light text-sm transition-colors">
                FAQ
              </a>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <a
                href="mailto:hello@starknkd.com"
                className="text-white/85 hover:text-sunset font-light text-sm transition-colors"
              >
                hello@starknkd.com
              </a>
              <a
