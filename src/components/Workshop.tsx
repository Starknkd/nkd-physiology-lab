const Workshop = () => {
  ...
  <a
    ...
    className="text-base text-white/60 hover:text-white hover:opacity-100 transition-all duration-200"
  >
    Not sure yet? Start with your breathing <span className="text-white/80 group-hover:text-white">
  blueprint →
</span> 
  </a>
</div>
