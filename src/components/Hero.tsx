    ...
    >
      ...
      <div className="relative w-full h-72 md:w-1/2 md:h-auto flex-shrink-0">
        <img
          ...
          alt=""
          aria-hidden="true"
          className="w-full h-full object-cover pointer-events-none brightness-110 contrast-110 md:brightness-100 md:contrast-100"
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to right, rgba(19,7,48,1) 0%, rgba(19,7,48,0.25) 40%, rgba(19,7,48,0) 100%)",
          }}
        />
      </div>
