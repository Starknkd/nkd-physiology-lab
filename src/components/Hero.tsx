    ...
    >
      ...
      <div className="relative w-full h-72 md:w-1/2 md:h-auto flex-shrink-0">
        <img
          ...
          alt=""
          aria-hidden="true"
         className="w-full h-full object-cover pointer-events-none brightness-110 contrast-110 saturate-125 md:brightness-100 md:contrast-100 md:saturate-100"
      ...
      <div
        ...
        style={{
          linear-gradient(to bottom, rgba(19,7,48,0) 90%, rgba(19,7,48,0.25) 97%, rgba(19,7,48,1) 100%)
        }}
      />
    </section>
  );
